<?php
  ...
  $conform = $data['statewise'][31]['confirmed'];
  $active = $data['statewise'][31]['active'];
  $death = $data['statewise'][31]['deaths'];
  $recovered = $data['statewise'][31]['recovered'];
  $ltime = $data['statewise'][31]['lastupdatedtime'];
...
<body style="background-color: #ECECEC">
  ...
  <h1 style="color: red; text-align: center;">CURRENT MIZORAM STATE COVID-19 CASES DATA</h1>
  <div class="content" style="background-color: #ECECEC">
    ...
    <?php
      ...
      <div class='container-fluid'>
          ...
          <div class='col-md-6' >
            <div class='card'>
              <div class='card-header'>
                <h3 class='card-title'>Cities of Mizoram [ Last Updated Time : $ltime ]</h3>
              </div>
              <!-- /.card-header -->
        ...
        foreach ($data1["Mizoram"]["districtData"] as $key => $value) {
           $str .= " <tr>
                      <td>" .$key."</td>
                      <td>".$data1["Mizoram"]["districtData"][$key]["confirmed"]."</td>
                      <td>".$data1["Mizoram"]["districtData"][$key]["active"]."</td>
                      <td>".$data1["Mizoram"]["districtData"][$key]["recovered"]."</td>
                      <td>".$data1["Mizoram"]["districtData"][$key]["deceased"]."</td>
                    </tr>";
        }
