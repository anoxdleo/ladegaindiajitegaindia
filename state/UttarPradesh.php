<?php
  ...
  $conform = $data['statewise'][7]['confirmed'];
  $active = $data['statewise'][7]['active'];
  $death = $data['statewise'][7]['deaths'];
  $recovered = $data['statewise'][7]['recovered'];
  $ltime = $data['statewise'][7]['lastupdatedtime']
...
<head>
  ...
  <title>COVID19 | UTTAR PRADESH</title>
...
<body style="background-color: #ECECEC">
  ...
  <h1 style="color: red; text-align: center;">CURRENT UTTAR PRADESH STATE COVID-19 CASES DATA</h1>
  <div class="content" style="background-color: #ECECEC">
    ...
    <?php
      ...
      <div class='container-fluid'>
          ...
          <div class='col-md-6' >
            <div class='card'>
              <div class='card-header'>
                <h3 class='card-title'>Cities of Uttar Pradesh [ Last Updated Time : $ltime ]</h3>
              </div>
              <!-- /.card-header -->
        ...
        foreach ($data1["Uttar Pradesh"]["districtData"] as $key => $value) {
           $str .= " <tr>
                      <td>" .$key."</td>
                      <td>".$data1["Uttar Pradesh"]["districtData"][$key]["confirmed"]."</td>
                      <td>".$data1["Uttar Pradesh"]["districtData"][$key]["active"]."</td>
                      <td>".$data1["Uttar Pradesh"]["districtData"][$key]["recovered"]."</td>
                      <td>".$data1["Uttar Pradesh"]["districtData"][$key]["deceased"]."</td>
                    </tr>";
        }
        $str .= "</tbody>
                </table>
