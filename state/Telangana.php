<?php
  ...
  $conform = $data['statewise'][8]['confirmed'];
  $active = $data['statewise'][8]['active'];
  $death = $data['statewise'][8]['deaths'];
  $recovered = $data['statewise'][8]['recovered'];
  $ltime = $data['statewise'][8]['lastupdatedtime']
...
<body style="background-color: #ECECEC">
  ...
  <h1 style="color: red; text-align: center;">CURRENT TELANGANA STATE COVID-19 CASES DATA</h1>
  <div class="content" style="background-color: #ECECEC">
    ...
    <?php
      ...
      <div class='container-fluid'>
          ...
          <div class='col-md-6' >
            <div class='card'>
              <div class='card-header'>
                <h3 class='card-title'>Cities of Telangana[ Last Updated Time : $ltime ]</h3>
              </div>
              <!-- /.card-header -->
        ...
        foreach ($data1["Telangana"]["districtData"] as $key => $value) {
           $str .= " <tr>
                      <td>" .$key."</td>
                      <td>".$data1["Telangana"]["districtData"][$key]["confirmed"]."</td>
                      <td>".$data1["Telangana"]["districtData"][$key]["active"]."</td>
                      <td>".$data1["Telangana"]["districtData"][$key]["recovered"]."</td>
                      <td>".$data1["Telangana"]["districtData"][$key]["deceased"]."</td>
                    </tr>";
        }
        $str .= "</tbody>
                </table>
