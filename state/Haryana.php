<?php
  ...
  $conform = $data['statewise'][14]['confirmed'];
  $active = $data['statewise'][14]['active'];
  $death = $data['statewise'][14]['deaths'];
  $recovered = $data['statewise'][14]['recovered'];
  $ltime = $data['statewise'][14]['lastupdatedtime']
...
<body style="background-color: #ECECEC">
  ...
  <h1 style="color: red; text-align: center;">CURRENT HARYANA STATE COVID-19 CASES DATA</h1>
  <div class="content" style="background-color: #ECECEC">
    ...
    <?php
      ...
      <div class='container-fluid'>
          ...
          <div class='col-md-6' >
            <div class='card'>
              <div class='card-header'>
                <h3 class='card-title'>Cities of Haryana [ Last Updated Time : $ltime ]</h3>
              </div>
              <!-- /.card-header -->
        ...
        foreach ($data1["Haryana"]["districtData"] as $key => $value) {
           $str .= " <tr>
                      <td>" .$key."</td>
                      <td>".$data1["Haryana"]["districtData"][$key]["confirmed"]."</td>
                      <td>".$data1["Haryana"]["districtData"][$key]["active"]."</td>
                      <td>".$data1["Haryana"]["districtData"][$key]["recovered"]."</td>
                      <td>".$data1["Haryana"]["districtData"][$key]["deceased"]."</td>
                    </tr>";
        }
        $str .= "</tbody>
                </table>
