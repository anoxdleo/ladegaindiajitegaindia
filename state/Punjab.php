<?php
  ...
  $conform = $data['statewise'][15]['confirmed'];
  $active = $data['statewise'][15]['active'];
  $death = $data['statewise'][15]['deaths'];
  $recovered = $data['statewise'][15]['recovered'];
  $ltime = $data['statewise'][15]['lastupdatedtime']
...
<h1 style="color: red; text-align: center;">CURRENT PUNJAB STATE COVID-19 CASES DATA</h1>
  <div class="content" style="background-color: #ECECEC">
    ...
    <?php
      ...
      <div class='container-fluid'>
          ...
          <div class='col-md-6' >
            <div class='card'>
              <div class='card-header'>
                <h3 class='card-title'>Cities of Punjab [ Last Updated Time : $ltime ]</h3>
              </div>
              <!-- /.card-header -->
        ...
        foreach ($data1["Punjab"]["districtData"] as $key => $value) {
           $str .= " <tr>
                      <td>" .$key."</td>
                      <td>".$data1["Punjab"]["districtData"][$key]["confirmed"]."</td>
                      <td>".$data1["Punjab"]["districtData"][$key]["active"]."</td>
                      <td>".$data1["Punjab"]["districtData"][$key]["recovered"]."</td>
                      <td>".$data1["Punjab"]["districtData"][$key]["deceased"]."</td>
                    </tr>";
        }
        $str .= "</tbody>
                </table>
