<?php
  ...
  $conform = $data['statewise'][2]['confirmed'];
  $active = $data['statewise'][2]['active'];
  $death = $data['statewise'][2]['deaths'];
  $recovered = $data['statewise'][2]['recovered'];
  $ltime = $data['statewise'][2]['lastupdatedtime']
...
<body style="background-color: #ECECEC">
 <h1 style="color: red; text-align: center;">CURRENT DELHI STATE COVID-19 CASES DATA</h1>
  <div class="content" style="background-color: #ECECEC">
    ...
    <?php
      ...
      <div class='container-fluid'>
          ...
          <div class='col-md-6' >
            <div class='card'>
              <div class='card-header'>
                <h3 class='card-title'>Cities of Delhi [ Last Updated Time : $ltime ]</h3>
              </div>
              <!-- /.card-header -->
        ...
        foreach ($data1["Delhi"]["districtData"] as $key => $value) {
          if ($key=="Unknown") {
                        $str .= "<tr>
                                <td>".$key."<a href='#'' data-toggle='tooltip' title='Data Awaiting yet!''>
                                  <span class='ion-information-circled'></span>
                                </a></td>
                                <td>".$data1["Delhi"]["districtData"][$key]["confirmed"]."</td>
                                <td>".$data1["Delhi"]["districtData"][$key]["active"]."</td>
                                <td>".$data1["Delhi"]["districtData"][$key]["recovered"]."</td>
                                <td>".$data1["Delhi"]["districtData"][$key]["deceased"]."</td></tr>";
                      }
                      else{
           $str .= " <tr>
                      <td>" .$key."</td>
                      ...
                      <td>".$data1["Delhi"]["districtData"][$key]["active"]."</td>
                      <td>".$data1["Delhi"]["districtData"][$key]["recovered"]."</td>
                      <td>".$data1["Delhi"]["districtData"][$key]["deceased"]."</td>
                    </tr>";
        }
      }
        $str .= "</tbody>
