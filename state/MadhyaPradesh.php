<?php
  ...
  $conform = $data['statewise'][6]['confirmed'];
  $active = $data['statewise'][6]['active'];
  $death = $data['statewise'][6]['deaths'];
  $recovered = $data['statewise'][6]['recovered'];
  $ltime = $data['statewise'][6]['lastupdatedtime']
...
<head>
  ...
  <title>COVID19 | MADHYA PRADESH</title>
...
<body style="background-color: #ECECEC">
  ...
  <h1 style="color: red; text-align: center;">CURRENT MADHYA PRADESH STATE COVID-19 CASES DATA</h1>
  <div class="content" style="background-color: #ECECEC">
    ...
    <?php
      ...
      <div class='container-fluid'>
          ...
          <div class='col-md-6' >
            <div class='card'>
              <div class='card-header'>
                <h3 class='card-title'>Cities of Madhya Pradesh [ Last Updated Time : $ltime ]</h3>
              </div>
              <!-- /.card-header -->
        ...
        foreach ($data1["Madhya Pradesh"]["districtData"] as $key => $value) {
           $str .= " <tr>
                      <td>" .$key."</td>
                      <td>".$data1["Madhya Pradesh"]["districtData"][$key]["confirmed"]."</td>
                      <td>".$data1["Madhya Pradesh"]["districtData"][$key]["active"]."</td>
                      <td>".$data1["Madhya Pradesh"]["districtData"][$key]["recovered"]."</td>
                      <td>".$data1["Madhya Pradesh"]["districtData"][$key]["deceased"]."</td>
                    </tr>";
        }
        $str .= "</tbody>
                </table>
