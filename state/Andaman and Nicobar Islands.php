<?php
  ...
  $conform = $data['statewise'][25]['confirmed'];
  $active = $data['statewise'][25]['active'];
  $death = $data['statewise'][25]['deaths'];
  $recovered = $data['statewise'][25]['recovered'];
  $ltime = $data['statewise'][25]['lastupdatedtime'];
...
<head>
  ...
  <title> COVID19 | ANDAMAN AND NICOBAR ISLANDS</title>
...
<h1 style="color: red; text-align: center;">CURRENT ANDAMAN AND NICOBAR ISLANDS STATE COVID-19 CASES DATA</h1>
  <div class="content" style="background-color: #ECECEC">
    ...
    <?php
      ...
      <div class='container-fluid'>
          ...
          <div class='col-md-6' >
            <div class='card'>
              <div class='card-header'>
                <h3 class='card-title'>Cities of Andaman and Nicobar Islands [ Last Updated Time : $ltime ]</h3>
              </div>
              <!-- /.card-header -->
        ...
        foreach ($data1["Andaman and Nicobar Islands"]["districtData"] as $key => $value) {
           $str .= " <tr>
                      <td>" .$key."</td>
                      <td>".$data1["Andaman and Nicobar Islands"]["districtData"][$key]["confirmed"]."</td>
                      <td>".$data1["Andaman and Nicobar Islands"]["districtData"][$key]["active"]."</td>
                      <td>".$data1["Andaman and Nicobar Islands"]["districtData"][$key]["recovered"]."</td>
                      <td>".$data1["Andaman and Nicobar Islands"]["districtData"][$key]["deceased"]."</td>
                    </tr>";
        }
        $str .= "</tbody>
                </table>
