<?php
  ...
  $conform = $data['statewise'][33]['confirmed'];
  $active = $data['statewise'][33]['active'];
  $death = $data['statewise'][33]['deaths'];
  $recovered = $data['statewise'][33]['recovered'];
  $ltime = $death['statewise'][33]['lastupdatedtime'];
...
<body style="background-color: #ECECEC">
  ...
  <h1 style="color: red; text-align: center;">CURRENT NAGALAND STATE COVID-19 CASES DATA</h1>
          ...
          <div class='col-md-6' >
            <div class='card'>
              <div class='card-header'>
                <h3 class='card-title'>Cities of Nagaland [ Last Updated Time : $ltime ]</h3>
              </div>
              <!-- /.card-header -->
            ...
            foreach ($data1["Nagaland"]["districtData"] as $key => $value) {
           $str .= " <tr>
                      <td>" .$key."</td>
                      <td>".$data1["Nagaland"]["districtData"][$key]["confirmed"]."</td>
                      <td>".$data1["Nagaland"]["districtData"][$key]["active"]."</td>
                      <td>".$data1["Nagaland"]["districtData"][$key]["recovered"]."</td>
                      <td>".$data1["Nagaland"]["districtData"][$key]["deceased"]."</td>
                    </tr>";
        }
