...
<head>
  ...
  <title>COVID19 | MAHARASHTRA</title>
...
<body style="background-color: #ECECEC">
  ...
  <h1 style="color: red; text-align: center;">CURRENT MAHARASHTRA STATE COVID-19 CASES DATA</h1>
  <div class="content" style="background-color: #ECECEC">
    ...
    <?php
      ...
      <div class='container-fluid'>
          ...
          <div class='col-md-6' >
            <div class='card'>
              <div class='card-header'>
                <h3 class='card-title'>Cities of Maharashtra [ Last Updated Time : $ltime ]</h3>
              </div>
              <!-- /.card-header -->
        ...
        foreach ($data1["Maharashtra"]["districtData"] as $key => $value) {
           $str .= " <tr>
                      <td>" .$key."</td>
                      <td>".$data1["Maharashtra"]["districtData"][$key]["confirmed"]."</td>
                      <td>".$data1["Maharashtra"]["districtData"][$key]["active"]."</td>
                      <td>".$data1["Maharashtra"]["districtData"][$key]["recovered"]."</td>
                      <td>".$data1["Maharashtra"]["districtData"][$key]["deceased"]."</td>
                    </tr>";
        }
        $str .= "</tbody>
                </table>
