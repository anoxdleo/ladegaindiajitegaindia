<?php
  ...
  $conform = $data['statewise'][37]['confirmed'];
  $active = $data['statewise'][37]['active'];
  $death = $data['statewise'][37]['deaths'];
  $recovered = $data['statewise'][37]['recovered'];
  $ltime = $data['statewise'][37]['lastupdatedtime'];
...
<body style="background-color: #ECECEC">
  ...
  <h1 style="color: red; text-align: center;">CURRENT SIKKIM STATE COVID-19 CASES DATA</h1>
          ...
          <div class='col-md-6' >
            <div class='card'>
              <div class='card-header'>
                <h3 class='card-title'>Cities of Sikkim[ Last Updated Time : $ltime ]</h3>
              </div>
              <!-- /.card-header -->
            ...
            foreach ($data1["Sikkim"]["districtData"] as $key => $value) {
           $str .= " <tr>
                      <td>" .$key."</td>
                      <td>".$data1["Sikkim"]["districtData"][$key]["confirmed"]."</td>
                      <td>".$data1["Sikkim"]["districtData"][$key]["active"]."</td>
                      <td>".$data1["Sikkim"]["districtData"][$key]["recovered"]."</td>
                      <td>".$data1["Sikkim"]["districtData"][$key]["deceased"]."</td>
                    </tr>";
        }
