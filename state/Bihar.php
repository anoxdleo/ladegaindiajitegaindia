<?php
  ...
  $conform = $data['statewise'][16]['confirmed'];
  $active = $data['statewise'][16]['active'];
  $death = $data['statewise'][16]['deaths'];
  $recovered = $data['statewise'][16]['recovered'];
  $ltime = $data['statewise'][16]['lastupdatedtime']
...
<body style="background-color: #ECECEC">
  ...
  <h1 style="color: red; text-align: center;">CURRENT BIHAR STATE COVID-19 CASES DATA</h1>
  <div class="content" style="background-color: #ECECEC">
    ...
    <?php
      ...
      <div class='container-fluid'>
          ...
          <div class='col-md-6' >
            <div class='card'>
              <div class='card-header'>
                <h3 class='card-title'>Cities of Bihar [ Last Updated Time : $ltime ]</h3>
              </div>
              <!-- /.card-header -->
        ...
        foreach ($data1["Bihar"]["districtData"] as $key => $value) {
           $str .= " <tr>
                      <td>" .$key."</td>
                      <td>".$data1["Bihar"]["districtData"][$key]["confirmed"]."</td>
                      <td>".$data1["Bihar"]["districtData"][$key]["active"]."</td>
                      <td>".$data1["Bihar"]["districtData"][$key]["recovered"]."</td>
                      <td>".$data1["Bihar"]["districtData"][$key]["deceased"]."</td>
                    </tr>";
        }
        $str .= "</tbody>
                </table>
