<?php
  ...
  $conform = $data['statewise'][35]['confirmed'];
  $active = $data['statewise'][35]['active'];
  $death = $data['statewise'][35]['deaths'];
  $recovered = $data['statewise'][35]['recovered'];
  $ltime = $data['statewise'][35]['lastupdatedtime'];
...
<head>
  ...
  <title> COVID19 | DAMAN AND DIU</title>
...
<body style="background-color: #ECECEC">
 ...
 <h1 style="color: red; text-align: center;">CURRENT DAMAN AND DIU STATE COVID-19 CASES DATA</h1>
          ...
          <div class='col-md-6' >
            <div class='card'>
              <div class='card-header'>
                <h3 class='card-title'>Cities of Daman and Diu [ Last Updated Time : $ltime ]</h3>
              </div>
              <!-- /.card-header -->
            ...
            foreach ($data1["Daman and Diu"]["districtData"] as $key => $value) {
           $str .= " <tr>
                      <td>" .$key."</td>
                      <td>".$data1["Daman and Diu"]["districtData"][$key]["confirmed"]."</td>
                      <td>".$data1["Daman and Diu"]["districtData"][$key]["active"]."</td>
                      <td>".$data1["Daman and Diu"]["districtData"][$key]["recovered"]."</td>
                      <td>".$data1["Daman and Diu"]["districtData"][$key]["deceased"]."</td>
                    </tr>";
        }
