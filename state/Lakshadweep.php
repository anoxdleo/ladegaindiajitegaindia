<?php
  ...
  $conform = $data['statewise'][36]['confirmed'];
  $active = $data['statewise'][36]['active'];
  $death = $data['statewise'][36]['deaths'];
  $recovered = $data['statewise'][36]['recovered'];
  $ltime = $data['statewise'][36]['lastupdatedtime'];
...
<head>
  ...
  <title> COVID19 | LAKSHADWEEP</title>
...
<body style="background-color: #ECECEC">
   ...
   <h1 style="color: red; text-align: center;">CURRENT LAKSHADWEEP STATE COVID-19 CASES DATA</h1>
          ...
          <div class='col-md-6' >
            <div class='card'>
              <div class='card-header'>
                <h3 class='card-title'>Cities of Lakshadweep [ Last Updated Time : $ltime ]</h3>
              </div>
              <!-- /.card-header -->
            ...
            foreach ($data1["Lakshadweep"]["districtData"] as $key => $value) {
           $str .= " <tr>
                      <td>" .$key."</td>
                      <td>".$data1["Lakshadweep"]["districtData"][$key]["confirmed"]."</td>
                      <td>".$data1["Lakshadweep"]["districtData"][$key]["active"]."</td>
                      <td>".$data1["Lakshadweep"]["districtData"][$key]["recovered"]."</td>
                      <td>".$data1["Lakshadweep"]["districtData"][$key]["deceased"]."</td>
                    </tr>";
        }
