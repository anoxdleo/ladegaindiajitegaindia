<?php
  ...
  $conform = $data['statewise'][3]['confirmed'];
  $active = $data['statewise'][3]['active'];
  $death = $data['statewise'][3]['deaths'];
  $recovered = $data['statewise'][3]['recovered'];
  $ltime = $data['statewise'][3]['lastupdatedtime'];
      ...
      <div class='container-fluid'>
          ...
          <div class='col-md-6' >
            <div class='card'>
              <div class='card-header'>
                <h3 class='card-title'>Cities of Gujarat [ Last Updated Time : $ltime ]</h3>
              </div>
              <!-- /.card-header -->
        ...
        foreach ($data1["Gujarat"]["districtData"] as $key => $value) {
           $str .= " <tr>
                      ...
                      <td>".$data1["Gujarat"]["districtData"][$key]["active"]."</td>
                      <td>".$data1["Gujarat"]["districtData"][$key]["recovered"]."</td>
