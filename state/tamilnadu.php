<?php
  ...
  $conform = $data['statewise'][5]['confirmed'];
  $active = $data['statewise'][5]['active'];
  $death = $data['statewise'][5]['deaths'];
  $recovered = $data['statewise'][5]['recovered'];
  $ltime = $data['statewise'][5]['lastupdatedtime']
...
<head>
  ...
  <title>COVID19 | TAMIL NADU</title>
...
<body style="background-color: #ECECEC">
  ...
  <h1 style="color: red; text-align: center;">CURRENT TAMILNADU STATE COVID-19 CASES DATA</h1>
  <div class="content" style="background-color: #ECECEC">
    ...
    <?php
      ...
      <div class='container-fluid'>
          ...
          <div class='col-md-6' >
            <div class='card'>
              <div class='card-header'>
                <h3 class='card-title'>Cities of Tamil Nadu[ Last Updated Time : $ltime ]</h3>
              </div>
              <!-- /.card-header -->
        ...
        foreach ($data1["Tamil Nadu"]["districtData"] as $key => $value) {
           $str .= " <tr>
                      <td>" .$key."</td>
                      <td>".$data1["Tamil Nadu"]["districtData"][$key]["confirmed"]."</td>
                      <td>".$data1["Tamil Nadu"]["districtData"][$key]["active"]."</td>
                      <td>".$data1["Tamil Nadu"]["districtData"][$key]["recovered"]."</td>
                      <td>".$data1["Tamil Nadu"]["districtData"][$key]["deceased"]."</td>
                    </tr>";
        }
        $str .= "</tbody>
                </table>
