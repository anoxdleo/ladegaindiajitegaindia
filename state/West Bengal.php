<?php
  ...
  $conform = $data['statewise'][13]['confirmed'];
  $active = $data['statewise'][13]['active'];
  $death = $data['statewise'][13]['deaths'];
  $recovered = $data['statewise'][13]['recovered'];
  $ltime = $data['statewise'][13]['lastupdatedtime']
...
<head>
  ...
  <title>COVID19 | WEST BENGAL </title>
...
<body style="background-color: #ECECEC">
  ...
  <h1 style="color: red; text-align: center;">CURRENT WEST BENGAL STATE COVID-19 CASES DATA</h1>
  <div class="content" style="background-color: #ECECEC">
    ...
    <?php
      ...
      <div class='container-fluid'>
          ...
          <div class='col-md-6' >
            <div class='card'>
              <div class='card-header'>
                <h3 class='card-title'>Cities of West Bengal[ Last Updated Time : $ltime ]</h3>
              </div>
              <!-- /.card-header -->
        ...
        foreach ($data1["West Bengal"]["districtData"] as $key => $value) {
           $str .= " <tr>
                      <td>" .$key."</td>
                      <td>".$data1["West Bengal"]["districtData"][$key]["confirmed"]."</td>
                      <td>".$data1["West Bengal"]["districtData"][$key]["active"]."</td>
                      <td>".$data1["West Bengal"]["districtData"][$key]["recovered"]."</td>
                      <td>".$data1["West Bengal"]["districtData"][$key]["deceased"]."</td>
                    </tr>";
        }
        $str .= "</tbody>
                </table>
