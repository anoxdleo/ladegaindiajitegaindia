<?php
  ...
  $conform = $data['statewise'][32]['confirmed'];
  $active = $data['statewise'][32]['active'];
  $death = $data['statewise'][32]['deaths'];
  $recovered = $data['statewise'][32]['recovered'];
  $ltime = $data['statewise'][32]['lastupdatedtime'];
...
<head>
  ...
  <title> COVID19 | ARUNACHAL PRADESH</title>
...
<h1 style="color: red; text-align: center;">CURRENT ARUNACHAL PRADESH STATE COVID-19 CASES DATA</h1>
  <div class="content" style="background-color: #ECECEC">
    ...
    <?php
      ...
      <div class='container-fluid'>
          ...
          <div class='col-md-6' >
            <div class='card'>
              <div class='card-header'>
                <h3 class='card-title'>Cities of Arunachal Pradesh [ Last Updated Time : $ltime ]</h3>
              </div>
              <!-- /.card-header -->
        ...
        foreach ($data1["Arunachal Pradesh"]["districtData"] as $key => $value) {
           $str .= " <tr>
                      <td>" .$key."</td>
                      <td>".$data1["Arunachal Pradesh"]["districtData"][$key]["confirmed"]."</td>
                      <td>".$data1["Arunachal Pradesh"]["districtData"][$key]["active"]."</td>
                      <td>".$data1["Arunachal Pradesh"]["districtData"][$key]["recovered"]."</td>
                      <td>".$data1["Arunachal Pradesh"]["districtData"][$key]["deceased"]."</td>
                    </tr>";
        }
