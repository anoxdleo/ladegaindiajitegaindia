<?php
  ...
  $conform = $data['statewise'][21]['confirmed'];
  $active = $data['statewise'][21]['active'];
  $death = $data['statewise'][21]['deaths'];
  $recovered = $data['statewise'][21]['recovered'];
  $ltime = $data['statewise'][21]['lastupdatedtime']
...
<head>
  ...
  <title>COVID19 | CHHATTUSGARH </title>
...
<body style="background-color: #ECECEC">
 <h1 style="color: red; text-align: center;">CURRENT CHHATTISGARH STATE COVID-19 CASES DATA</h1>
  <div class="content" style="background-color: #ECECEC">
    ...
    <?php
      ...
      <div class='container-fluid'>
          ...
          <div class='col-md-6' >
            <div class='card'>
              <div class='card-header'>
                <h3 class='card-title'>Cities of Chhattisgarh [ Last Updated Time : $ltime ]</h3>
              </div>
              <!-- /.card-header -->
        ...
        foreach ($data1["Chhattisgarh"]["districtData"] as $key => $value) {
           $str .= " <tr>
                      <td>" .$key."</td>
                      <td>".$data1["Chhattisgarh"]["districtData"][$key]["confirmed"]."</td>
                      <td>".$data1["Chhattisgarh"]["districtData"][$key]["active"]."</td>
                      <td>".$data1["Chhattisgarh"]["districtData"][$key]["recovered"]."</td>
                      <td>".$data1["Chhattisgarh"]["districtData"][$key]["deceased"]."</td>
                    </tr>";
        }
        $str .= "</tbody>
                </table>
