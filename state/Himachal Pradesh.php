<?php
  ...
  $conform = $data['statewise'][20]['confirmed'];
  $active = $data['statewise'][20]['active'];
  $death = $data['statewise'][20]['deaths'];
  $recovered = $data['statewise'][20]['recovered'];
  $ltime = $data['statewise'][20]['lastupdatedtime']
...
<head>
  ...
  <title>COVID19 | HIMACHAL PRADESH </title>
...
<body style="background-color: #ECECEC">
  ...
  <h1 style="color: red; text-align: center;">CURRENT HIMACHAL PRADESH STATE COVID-19 CASES DATA</h1>
  <div class="content" style="background-color: #ECECEC">
    ...
    <?php
      ...
      <div class='container-fluid'>
          ...
          <div class='col-md-6' >
            <div class='card'>
              <div class='card-header'>
                <h3 class='card-title'>Cities of Himachal Pradesh [ Last Updated Time : $ltime ]</h3>
              </div>
              <!-- /.card-header -->
        ...
        foreach ($data1["Himachal Pradesh"]["districtData"] as $key => $value) {
           $str .= " <tr>
                      <td>" .$key."</td>
                      <td>".$data1["Himachal Pradesh"]["districtData"][$key]["confirmed"]."</td>
                      <td>".$data1["Himachal Pradesh"]["districtData"][$key]["active"]."</td>
                      <td>".$data1["Himachal Pradesh"]["districtData"][$key]["recovered"]."</td>
                      <td>".$data1["Himachal Pradesh"]["districtData"][$key]["deceased"]."</td>
                    </tr>";
        }
        $str .= "</tbody>
                </table>
