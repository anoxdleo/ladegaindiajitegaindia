<?php
  ...
  $conform = $data['statewise'][28]['confirmed'];
  $active = $data['statewise'][28]['active'];
  $death = $data['statewise'][28]['deaths'];
  $recovered = $data['statewise'][28]['recovered'];
  $ltime = $data['statewise'][28]['lastupdatedtime'];
...
<head>
  ...
  <title> COVID19 | PUDUCHERRY</title>
...
<body style="background-color: #ECECEC">
  ...
  <h1 style="color: red; text-align: center;">CURRENT PUDUCHERRY STATE COVID-19 CASES DATA</h1>
  <div class="content" style="background-color: #ECECEC">
    ...
    <?php
      ...
      <div class='container-fluid'>
          ...
          <div class='col-md-6' >
            <div class='card'>
              <div class='card-header'>
                <h3 class='card-title'>Cities of Puducherry [ Last Updated Time : $ltime ]</h3>
              </div>
              <!-- /.card-header -->
        ...
        foreach ($data1["Puducherry"]["districtData"] as $key => $value) {
           $str .= " <tr>
                      <td>" .$key."</td>
                      <td>".$data1["Puducherry"]["districtData"][$key]["confirmed"]."</td>
                      <td>".$data1["Puducherry"]["districtData"][$key]["active"]."</td>
                      <td>".$data1["Puducherry"]["districtData"][$key]["recovered"]."</td>
                      <td>".$data1["Puducherry"]["districtData"][$key]["deceased"]."</td>
                    </tr>";
        }
        $str .= "</tbody>
                </table>
