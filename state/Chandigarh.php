<?php
  ...
  $conform = $data['statewise'][23]['confirmed'];
  $active = $data['statewise'][23]['active'];
  $death = $data['statewise'][23]['deaths'];
  $recovered = $data['statewise'][23]['recovered'];
  $ltime = $data['statewise'][23]['lastupdatedtime']
...
<head>
  ...
  <title>COVID19 | CHANDIGARH </title>
...
<body style="background-color: #ECECEC">
  ...
  <h1 style="color: red; text-align: center;">CURRENT CHANDIGARH STATE COVID-19 CASES DATA</h1>
  <div class="content" style="background-color: #ECECEC">
    ...
    <?php
      ...
      <div class='container-fluid'>
          ...
          <div class='col-md-6' >
            <div class='card'>
              <div class='card-header'>
                <h3 class='card-title'>Cities of Chandigarh [ Last Updated Time : $ltime ]</h3>
              </div>
              <!-- /.card-header -->
        ...
        foreach ($data1["Chandigarh"]["districtData"] as $key => $value) {
           $str .= " <tr>
                      <td>" .$key."</td>
                      <td>".$data1["Chandigarh"]["districtData"][$key]["confirmed"]."</td>
                      <td>".$data1["Chandigarh"]["districtData"][$key]["active"]."</td>
                      <td>".$data1["Chandigarh"]["districtData"][$key]["recovered"]."</td>
                      <td>".$data1["Chandigarh"]["districtData"][$key]["deceased"]."</td>
                    </tr>";
        }
        $str .= "</tbody>
                </table>
