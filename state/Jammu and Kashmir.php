<?php
  ...
  $conform = $data['statewise'][12]['confirmed'];
  $active = $data['statewise'][12]['active'];
  $death = $data['statewise'][12]['deaths'];
  $recovered = $data['statewise'][12]['recovered'];
  $ltime = $data['statewise'][12]['lastupdatedtime']
...
<head>
  ...
  <title>COVID19 | JAMMU AND KASHMIR</title>
...
<body style="background-color: #ECECEC">
  ...
  <h1 style="color: red; text-align: center;">CURRENT JAMMU AND KASHMIR STATE COVID-19 CASES DATA</h1>
  <div class="content" style="background-color: #ECECEC">
    ...
    <?php
      ...
      <div class='container-fluid'>
          ...
          <div class='col-md-6' >
            <div class='card'>
              <div class='card-header'>
                <h3 class='card-title'>Cities of Jammu and Kashmir [ Last Updated Time : $ltime ]</h3>
              </div>
              <!-- /.card-header -->
        ...
        foreach ($data1["Jammu and Kashmir"]["districtData"] as $key => $value) {
           $str .= " <tr>
                      <td>" .$key."</td>
                      <td>".$data1["Jammu and Kashmir"]["districtData"][$key]["confirmed"]."</td>
                      <td>".$data1["Jammu and Kashmir"]["districtData"][$key]["active"]."</td>
                      <td>".$data1["Jammu and Kashmir"]["districtData"][$key]["recovered"]."</td>
                      <td>".$data1["Jammu and Kashmir"]["districtData"][$key]["deceased"]."</td>
                    </tr>";
        }
        $str .= "</tbody>
                </table>
