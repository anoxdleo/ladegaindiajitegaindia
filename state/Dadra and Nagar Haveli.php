<?php
  ...
  $conform = $data['statewise'][34]['confirmed'];
  $active = $data['statewise'][34]['active'];
  $death = $data['statewise'][34]['deaths'];
  $recovered = $data['statewise'][34]['recovered'];
  $ltime = $data['statewise'][34]['lastupdatedtime'];
...
<head>
  ...
  <title> COVID19 | DADRA AND NAGAR HAVELI</title>
...
<body style="background-color: #ECECEC">
  ...
  <h1 style="color: red; text-align: center;">CURRENT DADRA AND NAGAR HAVELI STATE COVID-19 CASES DATA</h1>
  <div class="content" style="background-color: #ECECEC">
    ...
    <?php
        ...
        //print_r($state);
        if($conform==0 && $active==0 && $recovered==0 && $death==0)
        {
          echo "No CORONA patiant available";
        }    
        else
        {
          ...
          <div class='col-md-6' >
            <div class='card'>
              <div class='card-header'>
                <h3 class='card-title'>Cities of Dadra and Nagar Haveli [ Last Updated Time : $ltime ]</h3>
              </div>
              <!-- /.card-header -->
            ...
            foreach ($data1["Dadra and Nagar Haveli"]["districtData"] as $key => $value) {
           $str .= " <tr>
                      <td>" .$key."</td>
                      <td>".$data1["Dadra and Nagar Haveli"]["districtData"][$key]["confirmed"]."</td>
                      <td>".$data1["Dadra and Nagar Haveli"]["districtData"][$key]["active"]."</td>
                      <td>".$data1["Dadra and Nagar Haveli"]["districtData"][$key]["recovered"]."</td>
                      <td>".$data1["Dadra and Nagar Haveli"]["districtData"][$key]["deceased"]."</td>
                    </tr>";
        }
