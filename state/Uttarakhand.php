<?php
  ...
  $conform = $data['statewise'][18]['confirmed'];
  $active = $data['statewise'][18]['active'];
  $death = $data['statewise'][18]['deaths'];
  $recovered = $data['statewise'][18]['recovered'];
  $ltime = $data['statewise'][18]['lastupdatedtime']
...
<head>
  ...
  <title>COVID19 | UTTARAKHAND </title>
...
<body style="background-color: #ECECEC">
  ...
  <h1 style="color: red; text-align: center;">CURRENT UTTARAKHAND STATE COVID-19 CASES DATA</h1>
  <div class="content" style="background-color: #ECECEC">
    ...
    <?php
      ...
      <div class='container-fluid'>
          ...
          <div class='col-md-6' >
            <div class='card'>
              <div class='card-header'>
                <h3 class='card-title'>Cities of Uttarakhand [ Last Updated Time : $ltime ]</h3>
              </div>
              <!-- /.card-header -->
        ...
        foreach ($data1["Uttarakhand"]["districtData"] as $key => $value) {
           $str .= " <tr>
                      <td>" .$key."</td>
                      <td>".$data1["Uttarakhand"]["districtData"][$key]["confirmed"]."</td>
                      <td>".$data1["Uttarakhand"]["districtData"][$key]["active"]."</td>
                      <td>".$data1["Uttarakhand"]["districtData"][$key]["recovered"]."</td>
                      <td>".$data1["Uttarakhand"]["districtData"][$key]["deceased"]."</td>
                    </tr>";
        }
        $str .= "</tbody>
                </table>
